...
- [ ] **F3.9** Widget "งานวันนี้" + "งานเลยกำหนด" บน Dashboard **[M8]** — *เลื่อนไป Phase 8 ตามที่ตกลง (Phase 8 จะเขียน `DashboardContent.tsx` ใหม่ทั้งไฟล์อยู่แล้ว)*
...
> **ยกไป Phase 8 ทั้งหมด** — ตามโรดแมป §11 เฟส 8 ทำ Dashboard + รายงาน + Export อยู่แล้ว
> การแยกทำใน Phase 7 จะได้หน้ารายงานสองชุดที่ต้องมารวมกันทีหลัง (ตกลงกันเมื่อ 2 ก.ย. 2569)
